# Business Model: Seafood Processing Operations
...
## Classification
- Repository: `cloud-itonami-isic-1020` ([github.com/cloud-itonami/cloud-itonami-isic-1020](https://github.com/cloud-itonami/cloud-itonami-isic-1020))
- ISIC Rev.5: `1020` — Seafood Processing Operations
- Domain: `:food/seafood-processing`
- Social impact: :food-security :food-safety :fair-labor :marine-sustainability
- Actor: `:seafood-processing-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :food/seafood-processing — who wants
...
One managed tenant (:food/seafood-processing):
...
- Do not bypass the `:seafood-processing-governor` for production decisions.
