# Operator Quickstart — Seafood Processing Operations

Shortest path from clone to a verified local dry-run for **ISIC 1020** (`cloud-itonami-isic-1020`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1020.git
cd cloud-itonami-isic-1020
```
...
- Blueprint governor key: `seafood-processing-governor`
- Likely source path: `seafoodprocessing.governor.cljc`
